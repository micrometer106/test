...
function game_update(dt)
	...
	--update transmit
	if transmitornot == true then

		if nowtransmitpos[1][1] == transmitpos[1][1] and nowtransmitpos[1][2] == transmitpos[1][2] and nowtransmitpos[1][3] == transmitpos[1][3] then
			transmit(1,2)
		end
		if nowtransmitpos[1][1] == transmitpos[2][1] and nowtransmitpos[1][2] == transmitpos[2][2] and nowtransmitpos[1][3] == transmitpos[2][3] then
			transmit(2,1)
		end
		if nowtransmitpos[1][1] == transmitpos[3][1] and nowtransmitpos[1][2] == transmitpos[3][2] and nowtransmitpos[1][3] == transmitpos[3][3] then
			transmit(3,4)
		end
		if nowtransmitpos[1][1] == transmitpos[4][1] and nowtransmitpos[1][2] == transmitpos[4][2] and nowtransmitpos[1][3] == transmitpos[4][3] then
			transmit(4,3)
		end
		if nowtransmitpos[1][1] == transmitpos[5][1] and nowtransmitpos[1][2] == transmitpos[5][2] and nowtransmitpos[1][3] == transmitpos[5][3] then
			transmit(5,6)
		end
		if nowtransmitpos[1][1] == transmitpos[6][1] and nowtransmitpos[1][2] == transmitpos[6][2] and nowtransmitpos[1][3] == transmitpos[6][3] then
			transmit(6,5)
		end
		if nowtransmitpos[1][1] == transmitpos[7][1] and nowtransmitpos[1][2] == transmitpos[7][2] and nowtransmitpos[1][3] == transmitpos[7][3] then
			transmit(7,8)
		end
		if nowtransmitpos[1][1] == transmitpos[8][1] and nowtransmitpos[1][2] == transmitpos[8][2] and nowtransmitpos[1][3] == transmitpos[8][3] then
			transmit(8,7)
		end
		if nowtransmitpos[1][1] == transmitpos[9][1] and nowtransmitpos[1][2] == transmitpos[9][2] and nowtransmitpos[1][3] == transmitpos[9][3] then
			transmit(9,10)
		end
		if nowtransmitpos[1][1] == transmitpos[10][1] and nowtransmitpos[1][2] == transmitpos[10][2] and nowtransmitpos[1][3] == transmitpos[10][3] then
			transmit(10,9)
		end
	end
...
function game_draw()
	...
	--if transmitornot == true then
	--	love.graphics.print(pl.x, 150, 150)
		--love.graphics.print(pl.y, 170, 150)
	--	love.graphics.print(pl.z, 270, 150)
		--love.graphics.print(transmitpos[5][1], 150, 200)
		--love.graphics.print(transmitpos[5][2], 170, 200)
		--love.graphics.print(transmitpos[5][3], 190, 200)
		--love.graphics.print(transmitpos[6][1], 150, 250)
	--	love.graphics.print(transmitpos[6][2], 170, 250)
	--	love.graphics.print(transmitpos[6][3], 190, 250)
	--	love.graphics.print(nowtransmitpos[1][1], 150, 300)
	--	love.graphics.print(nowtransmitpos[1][2], 170, 300)
	--	love.graphics.print(nowtransmitpos[1][3], 190, 300)
	--end
	...
	if filetable[currentmap].text then
		...
		love.graphics.setScissor(149, 0, width+1, 141)
		love.graphics.setColor(0, 0, 0, 200*alpha)
		love.graphics.rectangle("fill", 150, 1, width, 140)
		...
		love.graphics.rectangle("line", 150, 1, width, 140)
...
function transmit(from,to)
	...
	--if pl.x == transmitpos[from][1] and pl.y > transmitpos[from][2] - 1 and pl.z == transmitpos[from][3] then
		--pl.y = pl.y - 1
	--elseif pl.x == transmitpos[from][1] and pl.y <= transmitpos[from][2] - 1 and pl.z == transmitpos[from][3] then
		pl.x = transmitpos[to][1]
		pl.y = transmitpos[to][2]
		pl.z = transmitpos[to][3]
	--end

	--if pl.x == transmitpos[to][1] and pl.y < transmitpos[to][2] and pl.z == transmitpos[to][3] then
	--	pl.y = pl.y + 1
	--end
	...
	pl.y = transmitpos[to][2]
	transmitornot = false
	--if transmitpos[1][1] == pl.x and transmitpos[1][2] == pl.y and transmitpos[1][3] == pl.z then
		--pl.x = transmitpos[2][1]
		--pl.y = transmitpos[2][2]
	--	pl.z = transmitpos[2][3]
	--else
	--	pl.x = transmitpos[1][1]
	--	pl.y = transmitpos[1][2]
	--	pl.z = transmitpos[1][3]
	--end
end
...
function game_keypressed(key)
	...
	--elseif key == " " and fadetimer3 == 1.5 then
		--if perspective == "front" then
		--	if map2d[pl.x][pl.y] == 6 then
		--		transmitornot = true
		--		nowtransmitpos[1] = {pl.x,pl.y,pl.z}
		--	end
		--elseif perspective == "back" then
		--	if map2d[mapwidth-pl.x+1][pl.y] == 6 then
		--		trtransmitornot = true
		--		nowtransmitpos[1] = {pl.x,pl.y,pl.z}
		--	end
		--elseif perspective == "right" then
		--	if map2d[pl.z][pl.y] == 6 then
		--		transmitornot = true
		--		nowtransmitpos[1] = {pl.x,pl.y,pl.z}
		--	end
	--	elseif perspective == "left" then
	--		if map2d[mapdepth-pl.z+1][pl.y] == 6 then
	--			transmitornot = true
	--			nowtransmitpos[1] = {pl.x,pl.y,pl.z}
	--		end
	--	else
	--		if map[pl.x][pl.y][pl.z].tilenum == 6 then
	--			transmitornot = true
	--			nowtransmitpos[1] = {pl.x,pl.y,pl.z}
	--		end
	--	end
