...
function player:keypressed(key)
	...
	if perspective == "front" then
		...
		elseif key == " " then
			...
			elseif map[pl.x][pl.y][pl.z].tilenum == 9 then
				transmitornot = true
				nowtransmitpos[1] = {pl.x,pl.y,pl.z}
			end
		end
	...
	elseif perspective == "back" then
		...
		elseif key == " " then
			if map[pl.x][pl.y][pl.z].tilenum == 6 then
				transmitornot = true
				nowtransmitpos[1] = {pl.x,pl.y,pl.z}
			elseif map[pl.x][pl.y][pl.z].tilenum == 7 then
				transmitornot = true
				nowtransmitpos[1] = {pl.x,pl.y,pl.z}
			end
		end
	elseif perspective == "left" then
		...
		elseif key == " " then
			if map[pl.x][pl.y][pl.z].tilenum == 6 then
				transmitornot = true
				nowtransmitpos[1] = {pl.x,pl.y,pl.z}
			elseif map[pl.x][pl.y][pl.z].tilenum == 10 then
				transmitornot = true
				nowtransmitpos[1] = {pl.x,pl.y,pl.z}
			end
		end
	elseif perspective == "right" then
		...
		elseif key == " " then
			if map[pl.x][pl.y][pl.z].tilenum == 6 then
				transmitornot = true
				nowtransmitpos[1] = {pl.x,pl.y,pl.z}
			elseif map[pl.x][pl.y][pl.z].tilenum == 8 then
				transmitornot = true
				nowtransmitpos[1] = {pl.x,pl.y,pl.z}
			end
		end
